...
import com.cxwl.weather.eye.adapter.AdapterSelectPicture
import com.cxwl.weather.eye.common.CONST
import com.cxwl.weather.eye.dto.EyeDto
import com.cxwl.weather.eye.dto.SelectListener
 ...
 * 获取本地相册图片
 */
class ActivitySelectPicture : BaseActivity(), View.OnClickListener, SelectListener {

    private var mAdapter: AdapterSelectPicture? = null
        ...
        when (v!!.id) {
            R.id.tvControl -> {
                if (selectCount <= 0) {
                    ...
                    val list: ArrayList<EyeDto?> = ArrayList()
                    var i = 0
            ...
            when (requestCode) {
                1001 -> {
                    ...
                    try {
                        ...
                        dto.pictureUrl = cameraFile!!.absolutePath
                        dataList.add(1, dto)
                        if (mAdapter != null) {
                            mAdapter!!.notifyDataSetChanged()
                        }
