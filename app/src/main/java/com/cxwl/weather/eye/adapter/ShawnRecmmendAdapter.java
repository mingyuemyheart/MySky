 ...
 * 推荐实景
 */
public class ShawnRecmmendAdapter extends BaseAdapter{
	...
	public ShawnRecmmendAdapter(Activity activity, List<EyeDto> mArrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.shawn_adapter_recommend, null);
		...
		try {
			...
			params.width = (width-(int)CommonUtil.dip2px(activity, 30))/2;
