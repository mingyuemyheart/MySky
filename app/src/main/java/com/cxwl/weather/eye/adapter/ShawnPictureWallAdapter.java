 ...
 * 图集展示
 */
public class ShawnPictureWallAdapter extends BaseAdapter{
	...
	public ShawnPictureWallAdapter(Context context, List<EyeDto> mArrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.shawn_adapter_picture_wall, null);
