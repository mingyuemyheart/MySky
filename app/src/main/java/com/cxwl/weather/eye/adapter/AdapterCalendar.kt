 ...
 * 天气日历
 */
class AdapterCalendar constructor(private val context: Context?, private val mArrayList: ArrayList<EyeDto>?) : BaseAdapter() {
    ...
    override fun getView(position: Int, view: View?, parent: ViewGroup?): View? {
        ...
        val itemWidth = CommonUtil.widthPixels(context) / 2
