...
import com.cxwl.weather.eye.adapter.ShawnPictureWallAdapter;
 ...
 * 图集展示
 */
public class ShawnPictureWallActivity extends ShawnBaseActivity implements OnClickListener{
	...
	private ShawnPictureWallAdapter picAdapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.shawn_activity_picture_wall);
		mContext = this;
		showDialog();
		initWidget();
		initGridView();
	...
	private void initGridView() {
		...
		picAdapter = new ShawnPictureWallAdapter(mContext, picList);
	...
	private void initViewPager() {
		...
		for (int i = 0; i < urlList.size(); i++) {
			...
			ivTips[i] = imageView;
			if(i == 0){
				ivTips[i].setBackgroundResource(R.drawable.shawn_point_white);
			}else{
				ivTips[i].setBackgroundResource(R.drawable.shawn_point_gray);
			}
