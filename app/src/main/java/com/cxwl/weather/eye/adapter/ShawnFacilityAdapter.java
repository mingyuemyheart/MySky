 ...
 * 设备信息
 */
public class ShawnFacilityAdapter extends BaseAdapter{
	...
	public ShawnFacilityAdapter(Context context, List<EyeDto> mArrayList) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder mHolder;
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.shawn_adapter_facility, null);
